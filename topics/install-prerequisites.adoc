...
////
TODO
Track down the OCP hardware requirements and link to it here.
https://docs.openshift.com/container-platform/3.10/install/prerequisites.html
https://access.redhat.com/documentation/en-us/openshift_container_platform/3.10/html/installing_clusters/install-config-install-prerequisites#system-requirements
Kevin's instructions
